                        ...
                        <div class="row">
                            <div class="col-md-6 p-2 text-center">
                                <div class="bg-light px-3 py-5">
                                    ...
                                    <div class="mt-3">
                                        <h5 class="mb-2" style={{ fontWeight: "600" }}><Link to={'#'} class="stretched-link" style={{ color: "#9B5DE5" }}>Liability Coverage</Link></h5>
                            ...
                            <div class="col-md-6 p-2 text-center">
                                ...
                                <div class="bg-light px-3 py-5">
                                    ...
                                    <div class="mt-3">
                                        <h5 class="mb-2" style={{ fontWeight: "600" }}><Link to={'#'} class="stretched-link" style={{ color: "#9B5DE5" }}>Comprehensive coverage</Link></h5>
                            ...
                            <div class="col-md-6 p-2 text-center">
                                <div class="bg-light px-3 py-5">
                                    ...
                                    <div class="mt-3">
                                        <h5 class="mb-2" style={{ fontWeight: "600" }}><Link to={'#'} class="stretched-link" style={{ color: "#9B5DE5" }}>Collision coverage</Link></h5>
                            ...
                            <div class="col-md-6 p-2 text-center">
                                <div class="bg-light px-3 py-5">
                                    ...
                                    <div class="mt-3">
                                        <h5 class="mb-2" style={{ fontWeight: "600" }}><Link to={'#'} class="stretched-link" style={{ color: "#9B5DE5" }}>Medical payments coverage</Link></h5>
